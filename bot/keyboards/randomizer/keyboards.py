        ...
        [
            [
                InlineKeyboardButton(
                    ...
                    callback_data="randomizer|add_variable",
                ),
            ],
            [
                InlineKeyboardButton(
                    text="💬 Одно сообщение",
                    callback_data="randomizer|one_message",
                ),
            ],
            [
                InlineKeyboardButton(
                    text="⚡️ Начать генерацию",
                    callback_data="randomizer|start_generation",
                ),
            ],
        ],
    )
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f"var|add_val|{variable_index}",
                ),
            ],
            [
                InlineKeyboardButton(
                    text="🗑️ Удалить значение",
                    callback_data=f"var|delete_val|{variable_index}",
                ),
            ],
            [
                InlineKeyboardButton(
                    text="❌ Удалить переменную",
                    callback_data=f"var|delete_var|{variable_index}",
                ),
            ],
...
def deleteValuesForVariableKeyboard(values: list[str], variable_index: int):
    ...
    kb.inline_keyboard.append(
        [
            InlineKeyboardButton(
                text="🔙 Назад",
                callback_data="randomizer_delete_value|back",
            ),
        ],
    )
    return kb
...
def done_typing_keyboard_for_prompts():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Готово",
                    callback_data="done_typing_randomize_prompts",
                ),
            ],
        ],
    )
