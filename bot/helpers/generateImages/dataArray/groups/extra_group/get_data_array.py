...
def extra_group_get_data_array():
    ...
    data_array = [
        extra_setting_generate_data(
            model_name="isla_latina",
            model_index=101,
            picture_folder_id="1Brd_uLUafazD8IfVmIiSQMMMTioaYbdc",
            video_folder_id="1eROCCB950JjAeG7nDsSJuvg80J2E0Z1z",
            nsfw_video_folder_id="1550MJr1dQw6Y7KoQMcaq_xgTf0uL2YqA",
            prompt="",
            loras_weights=[0.55, 2.5, -0.3, 0.75, 1.2, 2.25, 0.05, 0.65],
