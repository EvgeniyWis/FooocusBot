from bot.helpers.generateImages.dataArray.setting_4.generate_data import (
    setting4_generate_data,
)


# Функция для генерации массива данных для запроса для настройки 4
async def setting4_get_data_array():
    # Массив дат с нужными параметрами для запроса
    dataArray = [
        setting4_generate_data(
            "tiffanygale.xo",
            "19cCMta3vuJ96Qf-NvK8xlUEiRc8tDbVs",  # Updated picture folder_id
            "1WxDZPUxNywzuXd0t0MGjT7yqT77GY07s",  # Updated videos folder_id
        ...
        setting4_generate_data(
            "rachelveneux",
            "1y8bWhpUIirpaHW24hqLJfvES01qEueo0",  # Updated picture folder_id
            "1P5XTobI77nJxLQZ5cD59r5z97ZdJPacf",  # Updated videos folder_id
            """photorealistic, high quality, vibrant colors, skin detail, BREAK 
            1girl, 18, sorority girl, brown hair, medium-large natural breasts, tan skin, blue eyes""",
            [2, 3.70, -1.70, 1.50, 1.00, 1.70, -0.70, 0.35],
        ),
        setting4_generate_data(
            "karine_montclair",
            "1zbBLdrjAIXzJbEt9PoUO1wexMF0JKVea",  # Updated picture folder_id
        ...
        setting4_generate_data(
            ...
            """photorealistic, high quality, vibrant colors, skin detail, BREAK 
            1girl, 18, sorority girl, ash-blonde hair, medium-large natural breasts, tan skin, green eyes""",
        ...
        setting4_generate_data(
            ...
            """photorealistic, high quality, vibrant colors, skin detail, BREAK 
            1girl, mulat, 18, sorority girl, white hair, medium-large natural breasts, extra tan skin, blue eyes""",
        ...
        setting4_generate_data(
            ...
            """photorealistic, high quality, vibrant colors, skin detail, BREAK 
            1girl, 18, sorority girl, white hair, medium-large natural breasts, extra tan skin, blue eyes""",
        ...
        setting4_generate_data(
            ...
            """photorealistic, high quality, vibrant colors, skin detail, BREAK 
            1girl, 18, sorority girl, platinum hair, medium-large natural breasts, extra tan skin, blue eyes, smirk""",
