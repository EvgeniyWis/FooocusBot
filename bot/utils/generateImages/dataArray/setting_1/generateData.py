...
def setting1_generateData(model_name: str, prompt: str, lorasWeights: list[int]):
    ...
    data = generateData(model_name, prompt, loras, advanced_params, base_config_model_name, negative_prompt, embeddings)
    return data